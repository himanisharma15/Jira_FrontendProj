    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-slate-900 dark:to-slate-800 px-4 py-12">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">Join us to start managing your projects</p>
        </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <p className="text-xs mt-1 opacity-75">View & update tasks</p>
                </button>
                <button
                  type="button"
                ...
                >
                  ...
                  <p className="text-xs mt-1 opacity-75">Full access & control</p>
                </button>
              </div>
            </div>
